						...
						<ul class="navbar-nav ml-lg-auto">
							...
							<li class="nav-item dropdown">
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									...
									<a class="dropdown-item active" href="Patient-Change-Password.jsp">Change-Password</a>
								</div>
							</li>
						</ul>
						<!-- Appointment -->
		...
		<div class="py-xl-5 py-lg-3">
			...
			<div class="d-flex">
				...
				<div class="contact-right-w3l appoint-form">
					<h5 class="title-w3 text-center mb-5">Fill Your Change Password form</h5>
					...
					<form action="PatientController" method="post">
						...
						<div class="form-group text-center">
							<input type="submit" class="btn_apt" name="action" value="Change Password">
						</div>
					</form>
				</div>
